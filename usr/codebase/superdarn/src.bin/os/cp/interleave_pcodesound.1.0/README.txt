...
Description:
===========
interleave_pcodesound is a variant on the pcodescan and
interleavesound radar control programs that performs a scan
nn a nonsequential manner by "interleaving" the beam
...
beams [even/odd]. Note that unlike previous versions of
